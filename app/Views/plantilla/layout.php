...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/layout/dashboard.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/nuevo.css'); ?>">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                <a
                  ...
                  class="nav-link d-flex align-items-center gap-2 active text-white"
                  aria-current="page"
                  href="<?= base_url('/home'); ?>">
                  <svg class="bi" aria-hidden="true">
