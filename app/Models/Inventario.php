...
class Inventario extends Model
{
    ...
    public function obtenerProductos()
    {
        ...
        $builder->select('i.*, CONCAT(pn.nombre, " ", pn.apellido) as costurero, CONCAT(p.nombre, " Color ", t.descripcion, " talla ", ta.descripcion) as producto');
        $builder->join('producto p', 'i.id_producto = p.id_producto');
        $builder->join('tono t', 'i.id_tono = t.id_tono', 'inner');
        $builder->join('talla ta', 'i.id_talla = ta.id_talla', 'inner');
